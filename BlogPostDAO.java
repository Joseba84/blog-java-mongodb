...
public class BlogPostDAO {
    ...
    public String addPost(String title, String body, List tags, String username) {
        ...
        post.append("title",title).append("author",username).append("body",body).append("permalink",permalink).append("tags",tags).append("comments", Collections.emptyList()).append("date",new Date());
